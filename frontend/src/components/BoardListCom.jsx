...
const BoardListCom = ({ Info: infoFromProps }) => {
  ...
  const exitGroup = async () => {
    ...
    try {
      const response = await axios.post(
        `h${API_URL}/groups/${thisGroupId}/leave`,
        {},
        {
          withCredentials: true,
        }
  ...
  const fetchLatestBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `h${API_URL}/groups/${thisGroupId}/boards?sort=newest`,
        { withCredentials: true }
      );
  ...
  const fetchOldestBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `h${API_URL}/groups/${thisGroupId}/boards?sort=oldest`,
        { withCredentials: true }
      );
  ...
  const fetchMaxHitBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `h${API_URL}/groups/${thisGroupId}/boards?sort=hit`,
        { withCredentials: true }
      );
  ...
  const fetchSearchedBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `h${API_URL}/groups/${thisGroupId}/boards?searchType=${searchType}&query=${searchTerm}`,
        { withCredentials: true }
      );
